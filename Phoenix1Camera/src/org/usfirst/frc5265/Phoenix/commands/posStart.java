 ...
 *
 */
public class posStart extends Command {
	private static double valuePosStart;
    ...
    protected void initialize() {
    	valuePosStart = SmartDashboard.getNumber("posStart");
    	Robot.stagArm.armSet(valuePosStart);
    }
